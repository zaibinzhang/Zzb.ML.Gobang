...
{
    public class NetworkLayer1
    {
        public NetworkLayer1(int length)
        {
            _neurons = new double[length];
        }

        public NetworkLayer1(double[] neurons)
        {
            _neurons = neurons;
        }

        public NetworkLayer1(double[] neurons, params double[][] weight) : this(neurons)
        {
        ...
        public void ForwardPropagation(NetworkLayer1 nextLayer)
        {
            if (nextLayer == null)
            {
                return;
        ...
        /// 计算神经元
        /// </summary>
        private void CalculateNeurons(NetworkLayer1 nextLayer)
        {
        ...
        /// 检查权重有没有初始化
        /// </summary>
        private void CheckWeights(NetworkLayer1 nextLayer)
        {
            if (_weights == null)
            {
        ...
        private void BackPropagation(NetworkLayer1 previousLayer, List<double> targets, double learningRate)
        {
